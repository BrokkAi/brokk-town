...
func TestLocalAPIAuthenticationOriginAndStrictInput(t *testing.T) {
	...
	for _, path := range []string{"/", "/app.js", "/town.js", "/tools.js", "/manage.js", "/scenery.js", "/skins.js", "/swarm.js", "/assets/buildings-atlas.png", "/assets/actors-atlas.png", "/assets/feature-study.png", "/assets/feature-reader.png", "/assets/simplifier-clarifier.png"} {
