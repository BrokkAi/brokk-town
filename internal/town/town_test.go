...
func newGH(n int) *fakeGH {
	return &fakeGH{p: pull(n), discussion: []Discussion{}, gate: MergeGate{PolicyKnown: true, SquashAllowed: true, Base: baseSHA, BaseRef: "main", Head: headSHA, State: "OPEN", Mergeable: "MERGEABLE", MergeState: "CLEAN"}, snapshot: inventory(pull(n))}
}
