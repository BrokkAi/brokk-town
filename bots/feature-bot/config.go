...
// ReviewAgent is the agent configuration for independent review batches,
// coverage corrections and review receipt recovery. It differs from research
// only in the overridden model and effort.
